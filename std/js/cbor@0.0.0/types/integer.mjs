...
export const encodeInteger = (number) => {
  ...
  let argument;
  switch(length){
    case 1: argument = 24; break;
    case 2: argument = 25; break;
    case 4: argument = 26; break;
    case 8: argument = 27; break;
  }
...
export const decodeInteger = (bytes, offset=0) => {
  ...
  let read=0;
  switch(argument){
    case 24: read = 1; break;
    case 25: read = 2; break;
    case 26: read = 8; break;
    case 27: read = 4; break;
  }
