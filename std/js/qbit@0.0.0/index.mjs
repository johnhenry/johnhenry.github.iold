import {add, subtract, multiply, divide, sqrt, power, negate, matrixMultiply} from "../complexnumber@0.0.0/ComplexMath.mjs";
import i from '../complexnumber@0.0.0/i.mjs';
import '../complexnumber@0.0.0/number-prototype.mjs';
export const QBit = class{
  constructor(ket0 = Math.SQRT1_2, ket1 = sqrt(subtract(1, multiply(ket0, ket0)))){
    this.ket0 = ket0;
    this.ket1 = ket1;
  }
  valueOf(){
    return this.val ?? (this.val = Math.random() < Math.abs(multiply(this.ket0, this.ket0)) ? 0 : 1);
  }
  toString(){
...
export const matrixTransform = (matrix)=>(qbit)=>new QBit(...matrixMultiply(
  matrix,
  [[qbit.ket0],
    [qbit.ket1]]).flat());
...
export const phaseShift = (phi)=> matrixTransform(
  [ [1, 0],
