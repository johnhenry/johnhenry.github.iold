...
export const fromRectangular = (real=0, imaginary=0)=>new ComplexNumber(real, imaginary);
export const fromPolar = (magnitude=0, angle=0)=>new ComplexNumber(undefined, undefined, magnitude, angle);
