...
await tester("Numbers", function *(){
  ...
  yield equal(SAMPLE_NUM.r, SAMPLE_NUM, "regular number should have real value of itself");
  yield equal(SAMPLE_NUM.m, SAMPLE_NUM, "regular number should have magnitude value of itself");
  yield equal(SAMPLE_NUM.i, 0, "regular number should have imaginary value of zero");
  yield equal(SAMPLE_NUM.a, 0, "regular number should have angle value of zero");
});
