...
export default class{
  constructor({saturation, lightness, max=Number.MAX_SAFE_INTEGER}={max:Number.MAX_SAFE_INTEGER}){
    this.max = max;
    if(saturation){
  ...
  color(angle=0, magnitude=0, {saturation, lightness} = {}){
    if(this.saturation !== undefined || saturation !== undefined){
      return hsl2rgb(angle, (saturation ?? this.saturation) , magnitude/this.max);
    }else{
