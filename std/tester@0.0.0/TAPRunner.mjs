...
export const run = async function * (
  ...
  // const outputs = test(plan);
  // while(true){
  //   if(planCalled & !started){
  //     if(num === undefined){
  //       yield resultRange(index - 1);
  //     }else{
  //       yield resultRange(num);
  //     }
  //     indexPrinted = true;
  //   }
  ...
  //     break;
  //   }
  //   if(value instanceof TestError){
  //     yield resultFail(value, index);
  //     fail++;
  //   } else {
  //     yield resultPass(value, index);
  //     pass++;
  //   }
  //   index++;
  //   tests++;
